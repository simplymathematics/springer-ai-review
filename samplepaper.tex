...
\begin{figure}[!ht]
    {\centering
    \includegraphics[width=.225\textwidth]{images/noisy_number.png}
...
\begin{figure*}[!ht]
    {\centering
    \includegraphics[,clip,width=0.9\textwidth]{images/attacks.pdf}
...
\begin{figure*}[]
    %\begin{subfigure}
          \includegraphics[,clip,width=0.9\textwidth]{images/samples/FGM.pdf}
     ...
     %\end{subfigure}
     %\begin{subfigure}
          \includegraphics[,clip,width=0.9\textwidth]{images/samples/PGD.pdf}
     ...
     %\end{subfigure}
     %\begin{subfigure}
          \includegraphics[,clip,width=0.9\textwidth]{images/samples/CW.pdf}
     ...
     %\end{subfigure}
     %\begin{subfigure}
          \includegraphics[,clip,width=0.9\textwidth]{images/samples/Deep.pdf}
...
\begin{figure*}[] 
    %\begin{subfigure}
          \includegraphics[,clip,width=0.9\textwidth]{images/samples/Pixel.pdf}
     ...
     %\end{subfigure}
     %\begin{subfigure}
          \includegraphics[,clip,width=0.9\textwidth]{images/samples/Thresh.pdf}
     ...
     %\end{subfigure}
     %\begin{subfigure}
          \includegraphics[,clip,width=0.9\textwidth]{images/samples/Patch.pdf}
     ...
     %\end{subfigure}
     %\begin{subfigure}
          \includegraphics[,clip,width=0.9\textwidth]{images/samples/HSJ.pdf}
